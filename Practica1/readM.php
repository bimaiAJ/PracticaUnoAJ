            ...
            <table>
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-success" href="updateM.php?identifier=<?php echo $row["identifier"]; ?>">Actualizar</a>
                            <a class="btn btn-danger"  href="deleteM.php?identifier=<?php echo $row["identifier"]; ?>">Borrar</a>
                        </td>
                    </tr>
                    <?php
                    $i++;
