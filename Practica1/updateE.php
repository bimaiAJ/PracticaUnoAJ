...
<div class="container jumbotron cambio">
    <h2>Actualización Estudiantes</h2>
    <form id="updateForm"> <!-- Asignamos un ID al formulario -->
        <div>
...
document.getElementById('updateForm').addEventListener('submit', function(event) {
    ...
    .then(data => {
        ...
        if (data.success) {
            responseDiv.innerHTML = '<div class="alert alert-success">Estudiante actualizado correctamente.</div>';
            setTimeout(() => {
    ...
    .catch(error => {
        // Manejar errores
        document.getElementById('responseMessage').innerHTML = '<div class="alert alert-danger">Error al actualizar el estudiante.</div>';
    });
});
</script>
